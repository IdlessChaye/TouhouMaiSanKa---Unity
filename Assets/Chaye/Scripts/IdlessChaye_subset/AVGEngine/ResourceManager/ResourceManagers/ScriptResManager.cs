...
namespace IdlessChaye.IdleToolkit.AVGEngine {
    public class ScriptResManager<TValue> : BaseResManager<TValue> where TValue : class {
        private ScriptResBufferIndexer<TValue> bufferIndexer;

        public ScriptResManager(int bufferMaxCount) {
            bufferIndexer = new ScriptResBufferIndexer<TValue>(bufferMaxCount);
        }
